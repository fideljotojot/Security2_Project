<template>
    <form @submit.prevent="submitReset">
          ...
          <div class="form-group">
            <div class="form-group">
              ...
              <div class="password-input-wrapper">
                <input :type="showIdNumber ? 'text' : 'password'" v-model="idNumber" id="idNumber" name="idNumber" @input="validateIdNumber" autocomplete="off">
                <button type="button" class="toggle-password eye-icon"
                  :aria-label="showIdNumber ? 'Hide ID number' : 'Show ID number'" @click="showIdNumber = !showIdNumber">
                  <svg v-if="!showIdNumber" xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="registration-box">
          ...
          <div class="form-group">
            ...
            <div class="password-input-wrapper">
              ...
              >
              <button type="button" class="toggle-password eye-icon"
                :aria-label="showOtp ? 'Hide OTP' : 'Show OTP'" @click="showOtp = !showOtp">
                <svg v-if="!showOtp" xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24" fill="currentColor" class="size-6 eye-icon">
                    <path d="M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z" />
                    <path fill-rule="evenodd"
                      d="M1.323 11.447C2.811 6.976 7.028 3.75 12.001 3.75c4.97 0 9.185 3.223 10.675 7.69.12.362.12.752 0 1.113-1.487 4.471-5.705 7.697-10.677 7.697-4.97 0-9.186-3.223-10.675-7.69a1.762 1.762 0 0 1 0-1.113ZM17.25 12a5.25 5.25 0 1 1-10.5 0 5.25 5.25 0 0 1 10.5 0Z"
      ...
      <div class="btn-container" v-if="step === 3">
        <button type="button" @click="showIdNumber = false; step = 2" class="btn">Back</button>
        <button type="submit"
          class="btn"
      ...
      <div class="btn-container" v-if="step === 2">
        <button type="button" @click="showOtp = false; step = 1" class="btn">Back</button>
