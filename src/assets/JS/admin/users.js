...
export default {
  data: () => ({ users: [], search: '', status: 'all', selectedRole: 'all', selectedPosition: 'all', sortOrder: '', currentPage: 1, pageSize: 10, message: '', notificationTitle: '', notificationType: 'success', notificationMessage: '', editing: null, viewing: false, editForm: {}, editStep: 'personal', deleteTarget: null, deleteReason: '', showPasswordModal: false, confirmationPassword: '', showConfirmationPassword: false, isConfirmingPassword: false }),
