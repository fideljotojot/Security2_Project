...
export default {
  data: () => ({ users: [], search: '', status: 'all', selectedRole: 'all', sortOrder: '', currentPage: 1, pageSize: 5, message: '', editing: null, editForm: {}, editStep: 'personal', deleteTarget: null, deleteReason: '' }),
