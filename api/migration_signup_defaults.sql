-- Public signup accounts are always regular Students.
-- Apply after the profiles.position column migration.
...
BEGIN
  ...
  INSERT INTO public.users (id,id_number,username,email,role)
    VALUES (p_user_id,p_id_number,p_username,p_email,'user');
